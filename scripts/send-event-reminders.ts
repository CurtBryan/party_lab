...
async function sendEventReminders() {
  console.log('🔍 Checking for events that need 48-hour reminders...\n');
  ...
  console.log(`📧 Found ${bookings.length} booking(s) that need reminders:\n`);
...
Instagram: @partylabaz
      ...
      if (customerError) {
        ...
        console.log(`  ✅ Customer version sent to partylabaz`);
      }
